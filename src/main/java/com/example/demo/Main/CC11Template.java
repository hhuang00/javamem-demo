...
public class CC11Template {
    ...
    public static byte[] getBytes() throws IOException {
        //	第一次
        //InputStream inputStream = new FileInputStream(new File("/Users/admin/IdeaProjects/demo/target/classes/com/example/demo/Step1.class"));
        //  第二次
        InputStream inputStream = new FileInputStream(new File("/Users/admin/IdeaProjects/demo/target/classes/com/example/demo/TomcatInject.class"));
